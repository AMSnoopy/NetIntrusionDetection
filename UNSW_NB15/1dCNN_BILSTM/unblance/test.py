...
dropout_prob = 0.1
batch_size = 64
train_loader, test_loader = preprocess_data(batch_size)  # 数据预处理
...
model.eval()
# 在模型评估部分添加以下代码
classes = ['Normal', 'Generic', 'Exploits', 'Fuzzers', 'DoS', 'Reconnaissance', 'Analysis', 'Backdoor', 'Shellcode',
           'Worms']
